...
public class EntityEnderman extends EntityMob {
   ...
   public void func_146081_a(Block p_146081_1_) {
      this.dataWatcher.updateObject(16, (byte)(Block.getIdFromBlock(p_146081_1_) & 255));
   }
   ...
   static {
      attackingSpeedBoostModifier = (new AttributeModifier(attackingSpeedBoostModifierUUID, "Attacking speed boost", 6.199999809265137D, 0)).setSaved(false);
