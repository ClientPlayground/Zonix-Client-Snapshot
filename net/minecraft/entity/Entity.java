...
public abstract class Entity {
   ...
   public void moveEntity(double p_70091_1_, double p_70091_3_, double p_70091_5_) {
      if (this.noClip) {
         ...
         try {
            ...
            CrashReport var41 = CrashReport.makeCrashReport(var36, "Checking entity block collision");
   ...
   public static enum EnumEntitySize {
      ...
      public int multiplyBy32AndRound(double p_75630_1_) {
         ...
         case 6:
         default:
            return var3 > 0.0D ? MathHelper.ceiling_double_int(p_75630_1_ * 32.0D) : MathHelper.floor_double(p_75630_1_ * 32.0D);
         }
      }
   }
}
