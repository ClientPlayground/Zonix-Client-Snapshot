...
public class EntityFishHook extends Entity {
   ...
   public void onUpdate() {
      ...
      if (this.field_146055_aB > 0) {
         ...
         if (!this.field_146051_au) {
            ...
            for(this.rotationPitch = (float)(Math.atan2(this.motionY, (double)var30) * 180.0D / 3.141592653589793D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
               ;
            }
   ...
   private ItemStack func_146033_f() {
      ...
      if (var1 < var4) {
         ...
         return ((WeightedRandomFishable)WeightedRandom.getRandomItem(this.rand, (Collection)field_146039_d)).func_150708_a(this.rand);
      } else {
         var1 -= var4;
         if (var1 < var5) {
            this.field_146042_b.addStat(StatList.field_151184_B, 1);
            return ((WeightedRandomFishable)WeightedRandom.getRandomItem(this.rand, (Collection)field_146041_e)).func_150708_a(this.rand);
         } else {
            float var10000 = var1 - var5;
            this.field_146042_b.addStat(StatList.fishCaughtStat, 1);
            return ((WeightedRandomFishable)WeightedRandom.getRandomItem(this.rand, (Collection)field_146036_f)).func_150708_a(this.rand);
         }
      }
   }
