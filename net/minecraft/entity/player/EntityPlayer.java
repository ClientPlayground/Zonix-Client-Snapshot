   ...
   public EntityItem func_146097_a(ItemStack p_146097_1_, boolean p_146097_2_, boolean p_146097_3_) {
      if (p_146097_1_ == null) {
         ...
         if (p_146097_2_) {
            ...
            var5 = 0.3F;
            var4.motionX = (double)(-MathHelper.sin(this.rotationYaw / 180.0F * 3.1415927F) * MathHelper.cos(this.rotationPitch / 180.0F * 3.1415927F) * var5);
            var4.motionZ = (double)(MathHelper.cos(this.rotationYaw / 180.0F * 3.1415927F) * MathHelper.cos(this.rotationPitch / 180.0F * 3.1415927F) * var5);
            var4.motionY = (double)(-MathHelper.sin(this.rotationPitch / 180.0F * 3.1415927F) * var5 + 0.1F);
            var5 = 0.02F;
            var6 = this.rand.nextFloat() * 3.1415927F * 2.0F;
   ...
   public void attackTargetEntityWithCurrentItem(Entity p_71059_1_) {
      if (p_71059_1_.canAttackWithItem() && !p_71059_1_.hitByEntity(this)) {
         ...
         if (var2 > 0.0F || var4 > 0.0F) {
            ...
            if (var8) {
               if (var3 > 0) {
                  p_71059_1_.addVelocity((double)(-MathHelper.sin(this.rotationYaw * 3.1415927F / 180.0F) * (float)var3 * 0.5F), 0.1D, (double)(MathHelper.cos(this.rotationYaw * 3.1415927F / 180.0F) * (float)var3 * 0.5F));
                  this.motionX *= 0.6D;
                  this.motionZ *= 0.6D;
