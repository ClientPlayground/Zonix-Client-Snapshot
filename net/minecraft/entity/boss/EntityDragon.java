   ...
   public void onLivingUpdate() {
      ...
      if (this.getHealth() <= 0.0F) {
         ...
         if (this.worldObj.isClient) {
            ...
            this.rotationYaw = MathHelper.wrapAngleTo180_float(this.rotationYaw);
            var11 = 180.0D - Math.atan2(var26, var6) * 180.0D / 3.141592653589793D;
            ...
            Vec3 var39 = Vec3.createVectorHelper((double)MathHelper.sin(this.rotationYaw * 3.1415927F / 180.0F), this.motionY, (double)(-MathHelper.cos(this.rotationYaw * 3.1415927F / 180.0F))).normalize();
            var17 = (float)(var39.dotProduct(var15) + 0.5D) / 1.5F;
            if (var17 < 0.0F) {
               var17 = 0.0F;
            }
            ...
            var24 = (float)(var23.dotProduct(var39) + 1.0D) / 2.0F;
         ...
         var31 = MathHelper.sin(this.rotationYaw * 3.1415927F / 180.0F - this.randomYawVelocity * 0.01F);
         var17 = MathHelper.cos(this.rotationYaw * 3.1415927F / 180.0F - this.randomYawVelocity * 0.01F);
         this.dragonPartHead.onUpdate();
         this.dragonPartHead.setLocationAndAngles(this.posX + (double)(var31 * 5.5F * var3), this.posY + (var9[1] - var29[1]) * 1.0D + (double)(var27 * 5.5F), this.posZ - (double)(var17 * 5.5F * var3), 0.0F, 0.0F);
         ...
         for(int var30 = 0; var30 < 3; ++var30) {
            ...
            var21 = this.rotationYaw * 3.1415927F / 180.0F + this.simplifyAngle(var34[0] - var29[0]) * 3.1415927F / 180.0F * 1.0F;
            var22 = MathHelper.sin(var21);
            float var37 = MathHelper.cos(var21);
            var24 = 1.5F;
            float var40 = (float)(var30 + 1) * 2.0F;
            var32.onUpdate();
            var32.setLocationAndAngles(this.posX - (double)((var28 * var24 + var22 * var40) * var3), this.posY + (var34[1] - var29[1]) * 1.0D - (double)((var40 + var24) * var27) + 1.5D, this.posZ + (double)((var7 * var24 + var37 * var40) * var3), 0.0F, 0.0F);
         }
