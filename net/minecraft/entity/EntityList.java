...
public class EntityList {
   ...
   public static Entity createEntityByName(String p_75620_0_, World p_75620_1_) {
      ...
      try {
         ...
         if (var3 != null) {
            var2 = (Entity)var3.getConstructor(World.class).newInstance(p_75620_1_);
         }
   ...
   public static Entity createEntityFromNBT(NBTTagCompound p_75615_0_, World p_75615_1_) {
      ...
      try {
         ...
         if (var3 != null) {
            var2 = (Entity)var3.getConstructor(World.class).newInstance(p_75615_1_);
         }
      } catch (Exception var4) {
         var4.printStackTrace();
      }
   ...
   public static Entity createEntityByID(int p_75616_0_, World p_75616_1_) {
      ...
      try {
         ...
         if (var3 != null) {
            var2 = (Entity)var3.getConstructor(World.class).newInstance(p_75616_1_);
         }
      } catch (Exception var4) {
         var4.printStackTrace();
      }
