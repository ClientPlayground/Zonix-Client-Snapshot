...
public class ResUtils {
   ...
   public static String[] collectFiles(String[] prefixes, String[] suffixes) {
      ...
      String[] var7 = (String[])((String[])setPaths.toArray(new String[setPaths.size()]));
      return var7;
   }
   ...
   private static String[] collectFilesFixed(IResourcePack rp, String[] paths) {
      if (paths == null) {
         ...
         String[] var6 = (String[])((String[])((String[])list.toArray(new String[list.size()])));
         return var6;
      }
   }
   ...
   private static String[] collectFilesFolder(File tpFile, String basePath, String[] prefixes, String[] suffixes) {
      ...
      if (files == null) {
         ...
         String[] var13 = (String[])((String[])((String[])list.toArray(new String[list.size()])));
         return var13;
      }
   }
   ...
   private static String[] collectFilesZIP(File tpFile, String[] prefixes, String[] suffixes) {
      ...
      try {
         ...
         e.close();
         String[] names1 = (String[])((String[])((String[])list.toArray(new String[list.size()])));
         return names1;
