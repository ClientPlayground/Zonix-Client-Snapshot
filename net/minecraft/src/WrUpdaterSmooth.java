         ...
         for(dstIndex = 0; dstIndex < rg.worldRenderersToUpdate.size(); ++dstIndex) {
            ...
            if (i != null) {
               ...
               if (!i.needsUpdate) {
                  ...
                  var14 = i.distanceToEntitySquared(entityliving);
                  if (var14 <= 256.0F && rg.isActingNow()) {
                     i.updateRenderer();
                     i.needsUpdate = false;
                     rg.worldRenderersToUpdate.set(dstIndex, (Object)null);
                     ++this.renderersUpdated;
                     ...
                     if (!i.isInFrustum) {
                        var14 *= (float)NOT_IN_FRUSTRUM_MUL;
                     }
