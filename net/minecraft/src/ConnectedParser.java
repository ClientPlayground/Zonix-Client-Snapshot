...
public class ConnectedParser {
   ...
   public MatchBlock[] parseMatchBlocks(String propMatchBlocks) {
      if (propMatchBlocks == null) {
         ...
         MatchBlock[] var7 = (MatchBlock[])((MatchBlock[])((MatchBlock[])list.toArray(new MatchBlock[list.size()])));
         return var7;
      }
   }
   ...
   public BiomeGenBase[] parseBiomes(String str) {
      if (str == null) {
         ...
         BiomeGenBase[] var7 = (BiomeGenBase[])((BiomeGenBase[])((BiomeGenBase[])list.toArray(new BiomeGenBase[list.size()])));
         return var7;
      }
   }
