...
public class ConnectedProperties {
   ...
   private static BiomeGenBase[] parseBiomes(String str) {
      if (str == null) {
         ...
         BiomeGenBase[] var6 = (BiomeGenBase[])((BiomeGenBase[])((BiomeGenBase[])list.toArray(new BiomeGenBase[list.size()])));
         return var6;
      }
   }
   ...
   private String[] parseTileNames(String str) {
      if (str == null) {
         ...
         String[] var10 = (String[])((String[])((String[])list.toArray(new String[list.size()])));
   ...
   private static IIcon[] registerIcons(String[] tileNames, TextureMap textureMap) {
      if (tileNames == null) {
         ...
         IIcon[] var10 = (IIcon[])((IIcon[])((IIcon[])iconList.toArray(new IIcon[iconList.size()])));
         return var10;
      }
   }
