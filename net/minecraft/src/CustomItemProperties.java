...
public class CustomItemProperties {
   ...
   private int[] parseItems(String str, String str2) {
      ...
      if (str == null) {
         ...
         Integer[] var14 = (Integer[])((Integer[])((Integer[])setItemIds.toArray(new Integer[setItemIds.size()])));
   ...
   private NbtTagValue[] parseNbtTagValues(Properties props) {
      ...
      if (mapNbt.size() <= 0) {
         ...
         NbtTagValue[] nbts1 = (NbtTagValue[])((NbtTagValue[])((NbtTagValue[])listNbts.toArray(new NbtTagValue[listNbts.size()])));
         return nbts1;
      }
   }
