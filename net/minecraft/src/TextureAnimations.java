...
public class TextureAnimations {
   ...
   public static TextureAnimation[] getTextureAnimations(IResourcePack[] rps) {
      ...
      TextureAnimation[] var5 = (TextureAnimation[])((TextureAnimation[])((TextureAnimation[])list.toArray(new TextureAnimation[list.size()])));
      return var5;
   }
   ...
   public static TextureAnimation[] getTextureAnimations(IResourcePack rp) {
      ...
      if (animPropNames.length <= 0) {
         ...
         TextureAnimation[] var12 = (TextureAnimation[])((TextureAnimation[])((TextureAnimation[])list.toArray(new TextureAnimation[list.size()])));
         return var12;
      }
   }
