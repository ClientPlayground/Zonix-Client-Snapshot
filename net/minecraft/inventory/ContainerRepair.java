   ...
   public void updateRepairOutput() {
      ...
      if (var1 == null) {
         ...
         if (var6 != null) {
            ...
            if (var5.isItemStackDamageable() && var5.getItem().getIsRepairable(var1, var6)) {
               ...
               while(var21.hasNext()) {
                  ...
                  var13 = var7.containsKey(var11) ? ((Integer)var7.get(var11)).intValue() : 0;
                  var14 = ((Integer)var20.get(var11)).intValue();
                  int var10000;
                  if (var13 == var14) {
                     ++var14;
                     var10000 = var14;
                  ...
                  int var23;
                  while(var17.hasNext()) {
                     var23 = ((Integer)var17.next()).intValue();
                     if (var23 != var11 && !var22.canApplyTogether(Enchantment.enchantmentsList[var23])) {
                        var16 = false;
                        var2 += var15;
                     }
                  }
         ...
         for(var21 = var7.keySet().iterator(); var21.hasNext(); var19 += var9 + var13 * var14) {
            var11 = ((Integer)var21.next()).intValue();
            var22 = Enchantment.enchantmentsList[var11];
            var13 = ((Integer)var7.get(var11)).intValue();
            var14 = 0;
            ++var9;
            switch(var22.getWeight()) {
            case 1:
