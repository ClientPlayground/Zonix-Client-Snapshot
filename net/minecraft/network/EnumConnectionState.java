...
public enum EnumConnectionState {
   ...
   protected EnumConnectionState func_150751_a(int p_150751_1_, Class p_150751_2_) {
      String var3;
      if (this.field_150769_h.containsKey(p_150751_1_)) {
         var3 = "Serverbound packet ID " + p_150751_1_ + " is already assigned to " + this.field_150769_h.get(p_150751_1_) + "; cannot re-assign to " + p_150751_2_;
         ...
         this.field_150769_h.put(p_150751_1_, p_150751_2_);
         return this;
      }
   }
   ...
   protected EnumConnectionState func_150756_b(int p_150756_1_, Class p_150756_2_) {
      String var3;
      if (this.field_150770_i.containsKey(p_150756_1_)) {
         var3 = "Clientbound packet ID " + p_150756_1_ + " is already assigned to " + this.field_150770_i.get(p_150756_1_) + "; cannot re-assign to " + p_150756_2_;
         LogManager.getLogger().fatal(var3);
         throw new IllegalArgumentException(var3);
         ...
         this.field_150770_i.put(p_150756_1_, p_150756_2_);
         return this;
      }
   }
   ...
   private EnumConnectionState(String ignore1, int ignore2, int p_i1197_3_, Object p_i1197_4_) {
      this(p_i1197_3_);
   }
