...
public abstract class MinecraftServer implements ICommandSender, Runnable, IPlayerUsage {
         ...
         if (this.startServer()) {
            ...
            while(this.serverRunning) {
               ...
               if (var7 > 2000L && var1 - this.timeOfLastWarning >= 15000L) {
                  logger.warn("Can't keep up! Did the system time change, or is the server overloaded? Running {}ms behind, skipping {} tick(s)", new Object[]{var7, var7 / 50L});
                  var7 = 2000L;
   ...
   public void startServerThread() {
      (new MinecraftServer.ServerThread("Server Thread")).start();
   }
   ...
   public void addServerStatsToSnooper(PlayerUsageSnooper p_70000_1_) {
      ...
      p_70000_1_.func_152768_a("avg_tick_ms", (int)(MathHelper.average(this.tickTimeArray) * 1.0E-6D));
      int var2 = 0;
