                  ...
                  do {
                     do {
                        ...
                        do {
                           ...
                           var39 = (ChunkCoordIntPair)var38.next();
                        } while(((Boolean)this.eligibleChunksForSpawning.get(var39)).booleanValue());

                        ChunkPosition var40 = func_151350_a(p_77192_1_, var39.chunkXPos, var39.chunkZPos);
                        var14 = var40.field_151329_a;
                        var15 = var40.field_151327_b;
                        var16 = var40.field_151328_c;
                     } while(p_77192_1_.getBlock(var14, var15, var16).isNormalCube());
                  } while(p_77192_1_.getBlock(var14, var15, var16).getMaterial() != var37.getCreatureMaterial());
                        ...
                        if (canCreatureTypeSpawnAtLocation(var37, p_77192_1_, var19, var20, var21)) {
                           ...
                           if (p_77192_1_.getClosestPlayer((double)var26, (double)var27, (double)var28, 24.0D) == null) {
                              ...
                              if (var32 >= 576.0F) {
                                 ...
                                 EntityLiving var41;
                                 try {
                                    var41 = (EntityLiving)var23.entityClass.getConstructor(World.class).newInstance(p_77192_1_);
   ...
   public static void performWorldGenSpawning(World p_77191_0_, BiomeGenBase p_77191_1_, int p_77191_2_, int p_77191_3_, int p_77191_4_, int p_77191_5_, Random p_77191_6_) {
      ...
      if (!var7.isEmpty()) {
         while(p_77191_6_.nextFloat() < p_77191_1_.getSpawningChance()) {
            BiomeGenBase.SpawnListEntry var8 = (BiomeGenBase.SpawnListEntry)WeightedRandom.getRandomItem(p_77191_0_.rand, (Collection)var7);
            ...
            for(int var15 = 0; var15 < var10; ++var15) {
               ...
               for(int var17 = 0; !var16 && var17 < 4; ++var17) {
                  ...
                  if (canCreatureTypeSpawnAtLocation(EnumCreatureType.creature, p_77191_0_, var11, var18, var12)) {
                     ...
                     EntityLiving var22;
                     try {
                        var22 = (EntityLiving)var8.entityClass.getConstructor(World.class).newInstance(p_77191_0_);
