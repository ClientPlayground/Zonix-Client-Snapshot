   ...
   public boolean placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_, float p_77184_8_) {
      ...
      if (this.destinationCoordinateCache.containsItem(var17)) {
         ...
         for(var48 = var15 - var9; var48 <= var15 + var9; ++var48) {
            var49 = (double)var48 + 0.5D - p_77184_1_.posX;
            ...
            for(int var23 = var16 - var9; var23 <= var16 + var9; ++var23) {
               ...
               for(var30 = this.worldServerInstance.getActualHeight() - 1; var30 >= 0; --var30) {
                  if (this.worldServerInstance.getBlock(var48, var30, var23) == Blocks.portal) {
                     while(this.worldServerInstance.getBlock(var48, var30 - 1, var23) == Blocks.portal) {
                        --var30;
                     }

                     var27 = (double)var30 + 0.5D - p_77184_1_.posY;
      ...
      if (var10 >= 0.0D) {
         ...
         var30 = p_77184_1_.getTeleportDirection();
         if (var50 > -1) {
