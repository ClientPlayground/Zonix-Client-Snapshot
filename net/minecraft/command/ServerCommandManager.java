            ...
            do {
               do {
                  do {
                     ...
                     } while(var9 == p_152372_1_);
                  } while(!MinecraftServer.getServer().getConfigurationManager().func_152596_g(var9.getGameProfile()));
               } while(!p_152372_2_.canCommandSenderUseCommand(var9));
            } while(p_152372_1_ instanceof RConConsoleSource && !MinecraftServer.getServer().func_152363_m());
