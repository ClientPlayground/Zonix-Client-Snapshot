...
public class CommandHandler implements ICommandManager {
   ...
   public int executeCommand(ICommandSender p_71556_1_, String p_71556_2_) {
      ...
      try {
            ...
            if (var6 > -1) {
               ...
               for(int var12 = 0; var12 < var11; ++var12) {
                  ...
                  try {
                     ...
                     ChatComponentTranslation var15 = new ChatComponentTranslation(var18.getMessage(), var18.getErrorOjbects());
               ...
               try {
                  ...
                  var9 = new ChatComponentTranslation(var17.getMessage(), var17.getErrorOjbects());
         ...
         var9 = new ChatComponentTranslation("commands.generic.usage", new Object[]{new ChatComponentTranslation(var19.getMessage(), var19.getErrorOjbects())});
         var9.getChatStyle().setColor(EnumChatFormatting.RED);
         p_71556_1_.addChatMessage(var9);
      } catch (CommandException var20) {
         var9 = new ChatComponentTranslation(var20.getMessage(), var20.getErrorOjbects());
         var9.getChatStyle().setColor(EnumChatFormatting.RED);
         p_71556_1_.addChatMessage(var9);
         ...
         var9.getChatStyle().setColor(EnumChatFormatting.RED);
         p_71556_1_.addChatMessage(var9);
         logger.error("Couldn't process command: '" + p_71556_2_ + "'", var21);
      }
