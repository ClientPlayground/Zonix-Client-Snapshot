      ...
      if (p_71515_2_.length <= 0) {
         ...
         if (var5) {
            if (var7) {
               ...
               func_152373_a(p_71515_1_, this, "commands.xp.success.negative.levels", new Object[]{var6, var3.getCommandSenderName()});
            } else {
               var3.addExperienceLevel(var6);
               func_152373_a(p_71515_1_, this, "commands.xp.success.levels", new Object[]{var6, var3.getCommandSenderName()});
            }
         } else {
            if (var7) {
            ...
            func_152373_a(p_71515_1_, this, "commands.xp.success", new Object[]{var6, var3.getCommandSenderName()});
         }
