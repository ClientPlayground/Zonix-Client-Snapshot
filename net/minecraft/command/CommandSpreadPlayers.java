...
public class CommandSpreadPlayers extends CommandBase {
   ...
   public void processCommand(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if (p_71515_2_.length < 6) {
         ...
         while(true) {
            ...
            p_71515_1_.addChatMessage(new ChatComponentTranslation("commands.spreadplayers.spreading." + (var12 ? "teams" : "players"), new Object[]{var13.size(), var10, var4, var6, var8}));
   ...
   private void func_110669_a(ICommandSender p_110669_1_, List p_110669_2_, CommandSpreadPlayers.Position p_110669_3_, double p_110669_4_, double p_110669_6_, World p_110669_8_, boolean p_110669_9_) {
      ...
      func_152373_a(p_110669_1_, this, "commands.spreadplayers.success." + (p_110669_9_ ? "teams" : "players"), new Object[]{var19.length, p_110669_3_.field_111101_a, p_110669_3_.field_111100_b});
      if (var19.length > 1) {
