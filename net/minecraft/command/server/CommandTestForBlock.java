      ...
      if (p_71515_2_.length >= 4) {
         ...
         if (var6 == null) {
            ...
            if (!var8.blockExists(var3, var4, var5)) {
               ...
               if (var15 != var6) {
                  throw new CommandException("commands.testforblock.failed.tile", new Object[]{var3, var4, var5, var15.getLocalizedName(), var6.getLocalizedName()});
               } else {
                  if (var7 > -1) {
                     int var16 = var8.getBlockMetadata(var3, var4, var5);
                     if (var16 != var7) {
                        throw new CommandException("commands.testforblock.failed.data", new Object[]{var3, var4, var5, var16, var7});
                     }
                  }
