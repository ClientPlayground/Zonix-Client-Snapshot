   ...
   public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      if (this.field_146344_y) {
         ...
         if (WorldType.worldTypes[this.field_146331_K].func_151357_h()) {
            this.fontRendererObj.drawSplitString(I18n.format(WorldType.worldTypes[this.field_146331_K].func_151359_c()), this.field_146320_D.x + 2, this.field_146320_D.y + 22, this.field_146320_D.func_146117_b(), 10526880);
         }
      } else {
