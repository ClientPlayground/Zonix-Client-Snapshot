...
public class GuiIngame extends Gui {
   ...
   public void renderGameOverlay(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_) {
      ...
      if (this.mc.gameSettings.showDebugInfo) {
         ...
         var27 = MathHelper.floor_double((double)(this.mc.thePlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
         this.drawString(var8, "f: " + var27 + " (" + Direction.directions[var27] + ") / " + MathHelper.wrapAngleTo180_float(this.mc.thePlayer.rotationYaw), 2, 88, 14737632);
         ...
         this.drawString(var8, String.format("ws: %.3f, fs: %.3f, g: %b, fl: %d", this.mc.thePlayer.capabilities.getWalkSpeed(), this.mc.thePlayer.capabilities.getFlySpeed(), this.mc.thePlayer.onGround, this.mc.theWorld.getHeightValue(var22, var24)), 2, 104, 14737632);
      ...
      if (!this.mc.gameSettings.showDebugInfo && (this.mc.currentScreen == null || this.mc.currentScreen instanceof GuiChat)) {
         Iterator var44 = Client.getInstance().getModuleManager().getEnabledModules().iterator();

         while(var44.hasNext()) {
            IModule module = (IModule)var44.next();
            module.renderReal();
         }
      }
      ...
      Scoreboard scoreboard = (Scoreboard)Client.getInstance().getModuleManager().getModule("Scoreboard");
      ...
      if (this.mc.gameSettings.keyBindPlayerList.getIsKeyPressed() && (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.playerInfoList.size() > 1 || var37 != null)) {
         ...
         for(var21 = 0; var21 < var15; ++var21) {
            ...
            if (var21 < var42.size()) {
               ...
               if (var37 != null) {
                  var27 = var22 + var8.getStringWidth(var50) + 5;
   ...
   private void func_96136_a(ScoreObjective p_96136_1_, int p_96136_2_, int p_96136_3_, FontRenderer p_96136_4_) {
      net.minecraft.scoreboard.Scoreboard var5 = p_96136_1_.getScoreboard();
