...
public class ServerListEntryPinned implements GuiListExtended.IGuiListEntry {
   ...
   public void func_148279_a(int p_148279_1_, int p_148279_2_, int p_148279_3_, int p_148279_4_, int p_148279_5_, Tessellator p_148279_6_, int p_148279_7_, int p_148279_8_, boolean p_148279_9_) {
         ...
         field_148302_b.submit(new Runnable() {
            public void run() {
               ...
               while(ServerListEntryPinned.this.running) {
                  try {
                     ServerListEntryPinned.this.field_148303_c.func_146789_i().func_147224_a(ServerListEntryPinned.this.field_148301_e, (NetworkManager)null, (ServerAddress)null);
      ...
      RenderUtil.drawSquareTexture(pinnedIcon, 8.0F, (float)(p_148279_2_ - 32), (float)(p_148279_3_ + 1));
