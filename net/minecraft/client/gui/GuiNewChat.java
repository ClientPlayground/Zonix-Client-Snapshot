...
public class GuiNewChat extends Gui {
      ...
      if (this.field_146247_f.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
         ...
         if (var5 > 0) {
               ...
               if (var10 != null) {
                  ...
                  if (var11 < 200 || var3) {
                     ...
                     if (var14 > 3) {
                        byte var15 = 0;
                        int var16 = -var9 * 9;
                        if (!FPSBoost.FAST_CHAT.getValue().booleanValue()) {
                           drawRect(var15, var16 - 9, var15 + var8 + 4, var16, var14 / 2 << 24);
                        }

                        String var17 = var10.func_151461_a().getFormattedText();
                        if (!FPSBoost.CHAT_SHADOW.getValue().booleanValue()) {
                           this.field_146247_f.fontRenderer.drawString(var17, var15, var16 - 8, 16777215 + (var14 << 24));
                        } else {
            ...
            if (var3) {
               ...
               if (!FPSBoost.FAST_CHAT.getValue().booleanValue() && var18 != var11) {
   ...
   private void func_146237_a(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_) {
      ...
      IChatComponent var11;
      for(int var10 = 0; var10 < var9.size(); ++var10) {
         var11 = (IChatComponent)var9.get(var10);
      ...
      for(Iterator var21 = var8.iterator(); var21.hasNext(); this.field_146253_i.add(0, new ChatLine(p_146237_3_, var11, p_146237_2_))) {
         var11 = (IChatComponent)var21.next();
