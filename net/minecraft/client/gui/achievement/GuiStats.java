      ...
      public StatsMobsList() {
         ...
         while(true) {
            ...
            do {
               ...
               var3 = (EntityList.EntityEggInfo)var2.next();
            } while(GuiStats.this.field_146546_t.writeStat(var3.field_151512_d) <= 0 && GuiStats.this.field_146546_t.writeStat(var3.field_151513_e) <= 0);
