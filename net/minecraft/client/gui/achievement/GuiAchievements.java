   ...
   protected void func_146552_b(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
      ...
      for(var22 = 0; var22 < AchievementList.achievementList.size(); ++var22) {
         ...
         if (var34.parentAchievement != null) {
            ...
            int var27 = var34.parentAchievement.displayRow * 24 - var5 + 11;
            boolean var28 = this.field_146556_E.hasAchievementUnlocked(var34);
            boolean var29 = this.field_146556_E.canUnlockAchievement(var34);
