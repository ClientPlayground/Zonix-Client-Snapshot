...
public class Minecraft implements IPlayerUsage {
   ...
   private Queue tickTimes = new ArrayDeque();
   ...
   private void displayDebugInfo(long p_71366_1_) {
      if (this.mcProfiler.profilingEnabled) {
         ...
         for(int var11 = 0; var11 < var3.size(); ++var11) {
            ...
            for(var20 = var13; var20 >= 0; --var20) {
               var15 = (float)((var9 + var12.field_76332_a * (double)var20 / (double)var13) * 3.141592653589793D * 2.0D / 100.0D);
      ...
      if (this.tickTimes.size() == 200) {
         ...
         Long l;
         for(Iterator var21 = this.tickTimes.iterator(); var21.hasNext(); time += (double)l.longValue() / 1000000.0D) {
            l = (Long)var21.next();
         }
               ...
               do {
                  ...
                  do {
                     if (!Keyboard.next()) {
                        ...
                        EntityPlayer.EnumChatVisibility visibility;
                        for(; this.gameSettings.keyBindToggleChat.isPressed(); this.gameSettings.lastChatVisibility = visibility) {
                           visibility = this.gameSettings.chatVisibility;
   ...
   public void addServerStatsToSnooper(PlayerUsageSnooper p_70000_1_) {
      p_70000_1_.func_152768_a("fps", debugFPS);
