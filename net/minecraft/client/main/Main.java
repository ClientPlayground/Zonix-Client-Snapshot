...
public class Main {
   private static final Type field_152370_a = new Main.MCType();
   ...
   public static void main(String[] p_main_0_) {
      ...
      if (!var24.equals(Proxy.NO_PROXY) && func_110121_a(var25) && func_110121_a(var26)) {
         Authenticator.setDefault(new Main.MCAuthenticator(var25, var26));
      }
      ...
      Runtime.getRuntime().addShutdownHook(new Main.MCSShutdownHook("Client Shutdown Thread"));
      if (!var22.isEmpty()) {
