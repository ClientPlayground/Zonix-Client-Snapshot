...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   public void updateCameraAndRender(float p_78480_1_) {
      ...
      if (FPSBoost.LIGHTING.getValue().booleanValue() && this.lightmapUpdateNeeded) {
      ...
      if (!this.mc.skipRenderWorld) {
         ...
         if (this.mc.theWorld != null) {
            ...
            if (OpenGlHelper.shadersSupported && FPSBoost.SMART_PERFORMANCE.getValue().floatValue() >= 60.0F) {
               if (this.theShaderGroup != null) {
                  GL11.glMatrixMode(5890);
                  GL11.glPushMatrix();
                  GL11.glLoadIdentity();
   ...
   public void renderWorld(float p_78471_1_, long p_78471_2_) {
      float chunkAmount = FPSBoost.CHUNK_LOADING.getValue().floatValue();
      ...
      for(int var13 = 0; var13 < 2; ++var13) {
         ...
         if (var13 == 0) {
            ...
            ++this.chunksRendered;
            if ((float)this.chunksRendered >= 100.0F / chunkAmount) {
               this.chunksRendered = 0;
            }
         }
