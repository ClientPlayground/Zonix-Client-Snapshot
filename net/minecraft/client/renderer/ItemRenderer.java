...
public class ItemRenderer {
   ...
   public void renderItem(EntityLivingBase p_78443_1_, ItemStack p_78443_2_, int p_78443_3_) {
      ...
      if (p_78443_2_.getItemSpriteNumber() == 0 && var5 instanceof ItemBlock && RenderBlocks.renderItemIn3d(var6.getRenderType())) {
         ...
         if (p_78443_2_.hasEffect() && p_78443_3_ == 0 && FPSBoost.ITEM_GLINT.getValue().booleanValue()) {
   ...
   public void renderItemInFirstPerson(float p_78440_1_) {
      ...
      if (this.itemToRender == null || !(this.itemToRender.getItem() instanceof ItemCloth)) {
         ...
         GL11.glPopMatrix();
         float var6 = var3.prevRenderArmPitch + (var3.renderArmPitch - var3.prevRenderArmPitch) * p_78440_1_;
         float var7 = var3.prevRenderArmYaw + (var3.renderArmYaw - var3.prevRenderArmYaw) * p_78440_1_;
