...
public class RenderGlobal implements IWorldAccess {
   ...
   public int sortAndRender(EntityLivingBase player, int renderPass, double partialTicks) {
      ...
      if (FPSBoost.SMART_PERFORMANCE.getValue().floatValue() >= 20.0F && renderPass == 0) {
         GL11.glFinish();
      }
         ...
         if (Config.isCloudsFancy()) {
            ...
            if (this.isFancyGlListClouds || this.cloudTickCounter >= this.cloudTickCounterGlList + 20) {
               ...
               if (this.mc.gameSettings.anaglyph) {
                  ...
                  exactPlayerZ = (exactPlayerX * 30.0F + var8 * 70.0F) / 100.0F;
                  var12 = (exactPlayerX * 30.0F + exactPlayerY * 70.0F) / 100.0F;
                  exactPlayerX = var10;
                  var8 = exactPlayerZ;
                  exactPlayerY = var12;
               }
            ...
            var12 = (float)(exactPlayerY1 - this.cloudPlayerY);
            float cdz1 = (float)(exactPlayerZ1 - this.cloudPlayerZ);
            GL11.glTranslatef(-exactPlayerZ, -var12, -cdz1);
      ...
      if (!te.hasWorldObj()) {
         ...
         if (blockType == Blocks.enchanting_table) {
            ...
            if (blockType != null && blockType != Blocks.beacon) {
               AxisAlignedBB blockAabb = blockType.getCollisionBoundingBoxFromPool(te.getWorldObj(), te.field_145851_c, te.field_145848_d, te.field_145849_e);
               if (blockAabb != null) {
                  return blockAabb;
               }
            }
