         ...
         if ((var18 >> 24 & 255) > 0 || p_76986_1_.hurtTime > 0 || p_76986_1_.deathTime > 0) {
            ...
            if (p_76986_1_.hurtTime > 0 || p_76986_1_.deathTime > 0) {
               ...
               for(var21 = 0; var21 < 4; ++var21) {
                  if (this.inheritRenderPass(p_76986_1_, var21, p_76986_9_) >= 0) {
                     GL11.glColor4f(var27, 0.0F, 0.0F, 0.4F);
                     this.renderPassModel.render(p_76986_1_, var16, var15, var13, var11 - var10, var26, var14);
                  }
               }
   ...
   protected void renderArrowsStuckInEntity(EntityLivingBase p_85093_1_, float p_85093_2_) {
      ...
      if (var3 > 0) {
         ...
         for(int var6 = 0; var6 < var3; ++var6) {
            ...
            var4.prevRotationYaw = var4.rotationYaw = (float)(Math.atan2((double)var9, (double)var11) * 180.0D / 3.141592653589793D);
            var4.prevRotationPitch = var4.rotationPitch = (float)(Math.atan2((double)var10, (double)var15) * 180.0D / 3.141592653589793D);
            double var16 = 0.0D;
            double var18 = 0.0D;
            double var20 = 0.0D;
            float var22 = 0.0F;
