...
public class RenderBlocks {
   ...
   public boolean renderBlockByRenderType(Block par1Block, int par2, int par3, int par4) {
      ...
      if (i == -1) {
         return false;
      } else if ((par1Block instanceof BlockGlass || par1Block instanceof BlockStainedGlass) && FPSBoost.CLEAR_GLASS.getValue().booleanValue()) {
         return true;
      } else {
   ...
   public boolean renderBlockDoublePlant(BlockDoublePlant p_147774_1_, int p_147774_2_, int p_147774_3_, int p_147774_4_) {
      ...
      if (var20 && var60 == 0) {
         ...
         double var23 = Math.cos((double)var581 * 0.8D) * 3.141592653589793D * 0.1D;
