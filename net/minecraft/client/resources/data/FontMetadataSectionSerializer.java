   ...
   public FontMetadataSection deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
      ...
      if (var4.has("characters")) {
         ...
         if (var11.has("default")) {
            ...
            Validate.inclusiveBetween(0.0F, Float.MAX_VALUE, var8, "Invalid default width", new Object[0]);
            var9 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var12, "spacing", var9);
            Validate.inclusiveBetween(0.0F, Float.MAX_VALUE, var9, "Invalid default spacing", new Object[0]);
            var10 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var12, "left", var9);
            Validate.inclusiveBetween(0.0F, Float.MAX_VALUE, var10, "Invalid default left", new Object[0]);
         }
         ...
         for(int var18 = 0; var18 < 256; ++var18) {
            ...
            if (var13 != null) {
               ...
               Validate.inclusiveBetween(0.0F, Float.MAX_VALUE, var14, "Invalid width", new Object[0]);
               var15 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var17, "spacing", var9);
               Validate.inclusiveBetween(0.0F, Float.MAX_VALUE, var15, "Invalid spacing", new Object[0]);
               var16 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var17, "left", var10);
               Validate.inclusiveBetween(0.0F, Float.MAX_VALUE, var16, "Invalid left", new Object[0]);
            }
