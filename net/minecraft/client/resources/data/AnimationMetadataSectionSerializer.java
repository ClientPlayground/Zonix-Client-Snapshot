...
public class AnimationMetadataSectionSerializer extends BaseMetadataSectionSerializer implements JsonSerializer {
   ...
   public AnimationMetadataSection deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
      ...
      if (var6 != 1) {
         Validate.inclusiveBetween(Integer.valueOf(1), Integer.MAX_VALUE, var6, "Invalid default frame time", new Object[0]);
      }
      ...
      if (var12 != -1) {
         Validate.inclusiveBetween(Integer.valueOf(1), Integer.MAX_VALUE, var12, "Invalid width", new Object[0]);
      }

      if (var8 != -1) {
         Validate.inclusiveBetween(Integer.valueOf(1), Integer.MAX_VALUE, var8, "Invalid height", new Object[0]);
      }
   ...
   private AnimationFrame parseAnimationFrame(int p_110492_1_, JsonElement p_110492_2_) {
      if (p_110492_2_.isJsonPrimitive()) {
         ...
         if (var3.has("time")) {
            Validate.inclusiveBetween(Integer.valueOf(1), Integer.MAX_VALUE, var4, "Invalid frame time", new Object[0]);
         }

         int var5 = JsonUtils.getJsonObjectIntegerFieldValue(var3, "index");
         Validate.inclusiveBetween(Integer.valueOf(0), Integer.MAX_VALUE, var5, "Invalid frame index", new Object[0]);
