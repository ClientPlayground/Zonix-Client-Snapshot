...
public class EntityPlayerSP extends AbstractClientPlayer {
   ...
   public void onLivingUpdate() {
      Iterator var1 = Client.getInstance().getModuleManager().getEnabledModules().iterator();

      IModule module;
      while(var1.hasNext()) {
         module = (IModule)var1.next();
      ...
      var1 = Client.getInstance().getModuleManager().getEnabledModules().iterator();
