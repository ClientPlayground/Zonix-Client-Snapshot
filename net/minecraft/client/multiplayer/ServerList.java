...
public class ServerList {
   ...
   public final List servers = new ArrayList();
   private static final String __OBFID = "CL_00000891";
   public final List pinnedServers = Arrays.asList(new ServerData("Zonix US", "zonix.us", -1449640900), new ServerData("Zonix EU", "eu.zonix.us", -1455646628), new ServerData("Zonix SA", "sa.zonix.us", -1455659112), new ServerData("Zonix AS", "as.zonix.us", -1449640809));
