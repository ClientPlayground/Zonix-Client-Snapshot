...
public class BlockPortal extends BlockBreakable {
   ...
   public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_) {
      ...
      if (var6 != 1 || var7.func_150860_b() && var7.field_150864_e >= var7.field_150868_h * var7.field_150862_g) {
         if (var6 == 2 && (!var8.func_150860_b() || var8.field_150864_e < var8.field_150868_h * var8.field_150862_g)) {
   ...
   public static class Size {
      ...
      public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_) {
         ...
         int var7;
         for(var7 = p_i45415_3_; p_i45415_3_ > var7 - 21 && p_i45415_3_ > 0 && this.func_150857_a(p_i45415_1_.getBlock(p_i45415_2_, p_i45415_3_ - 1, p_i45415_4_)); --p_i45415_3_) {
            ;
         }

         var7 = this.func_150853_a(p_i45415_2_, p_i45415_3_, p_i45415_4_, this.field_150863_d) - 1;
         if (var7 >= 0) {
