...
public abstract class MobSpawnerBaseLogic {
   ...
   private void resetTimer() {
      ...
      if (this.minecartToSpawn != null && this.minecartToSpawn.size() > 0) {
         this.setRandomMinecart((MobSpawnerBaseLogic.WeightedRandomMinecart)WeightedRandom.getRandomItem(this.getSpawnerWorld().rand, (Collection)this.minecartToSpawn));
      }
