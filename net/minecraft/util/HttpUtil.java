      ...
      Thread var7 = new Thread(new Runnable() {
         ...
         public void run() {
            ...
            try {
               ...
               int var28x = var1.getContentLength();
               if (p_151223_5_ != null) {
               ...
               if (p_151223_0_.exists()) {
                  ...
                  HttpUtil.logger.warn("Deleting " + p_151223_0_ + " as it does not match what we currently have (" + var28x + " vs our " + var29 + ").");
                  p_151223_0_.delete();
