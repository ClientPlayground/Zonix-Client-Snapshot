...
public class MerchantRecipeList extends ArrayList {
   ...
   public MerchantRecipe canRecipeBeUsed(ItemStack p_77203_1_, ItemStack p_77203_2_, int p_77203_3_) {
      if (p_77203_3_ > 0 && p_77203_3_ < this.size()) {
         ...
         return p_77203_1_.getItem() != var6.getItemToBuy().getItem() || (p_77203_2_ != null || var6.hasSecondItemToBuy()) && (!var6.hasSecondItemToBuy() || p_77203_2_ == null || var6.getSecondItemToBuy().getItem() != p_77203_2_.getItem()) || p_77203_1_.stackSize < var6.getItemToBuy().stackSize || var6.hasSecondItemToBuy() && p_77203_2_.stackSize < var6.getSecondItemToBuy().stackSize ? null : var6;
      } else {
