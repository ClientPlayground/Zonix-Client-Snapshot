...
public class VillageCollection extends WorldSavedData {
   ...
   private void addNewDoorsToVillageOrCreateVillage() {
      for(int var1 = 0; var1 < this.newDoors.size(); ++var1) {
         ...
         Village var8;
         while(var4.hasNext()) {
            var8 = (Village)var4.next();
            int var6 = (int)var8.getCenter().getDistanceSquared(var2.posX, var2.posY, var2.posZ);
            int var7 = 32 + var8.getVillageRadius();
            if (var6 <= var7 * var7) {
         ...
         if (!var3) {
            var8 = new Village(this.worldObj);
            var8.addVillageDoorInfo(var2);
   ...
   private VillageDoorInfo getVillageDoorAt(int p_75547_1_, int p_75547_2_, int p_75547_3_) {
      ...
      while(var4.hasNext()) {
         ...
         VillageDoorInfo var6 = var7.getVillageDoorAt(p_75547_1_, p_75547_2_, p_75547_3_);
         if (var6 != null) {
            return var6;
         }
      }
