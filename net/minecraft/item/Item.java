   ...
   public static void registerItems() {
      ...
      while(true) {
         ...
         while(true) {
            ...
            var4 = (Block)Block.blockRegistry.getObject(var3);
            if (var4 == Blocks.wool) {
               var5 = (new ItemCloth(Blocks.wool)).setUnlocalizedName("cloth");
               break;
            }

            if (var4 == Blocks.stained_hardened_clay) {
