...
public class ZFont {
   protected ZFont.CharData[] charData = new ZFont.CharData[256];
   ...
   protected DynamicTexture setupTexture(Font font, boolean antiAlias, boolean fractionalMetrics, ZFont.CharData[] chars) {
   ...
   private BufferedImage generateFontImage(Font font, boolean antiAlias, boolean fractionalMetrics, ZFont.CharData[] chars) {
      ...
      for(int i = 0; i < chars.length; ++i) {
         char ch = (char)i;
         ZFont.CharData charData = new ZFont.CharData();
   ...
   protected void drawChar(ZFont.CharData[] chars, char c, float x, float y) throws ArrayIndexOutOfBoundsException {
      try {
