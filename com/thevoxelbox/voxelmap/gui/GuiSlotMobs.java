...
class GuiSlotMobs extends GuiSlot {
   ...
   public GuiSlotMobs(GuiMobs par1GuiMobs) {
      ...
      EnumMobs[] var2 = EnumMobs.values();
      int var3 = var2.length;

      for(int var4 = 0; var4 < var3; ++var4) {
         EnumMobs mob = var2[var4];
      ...
      Iterator var6 = CustomMobsManager.mobs.iterator();
      ...
      while(true) {
         ...
         do {
            if (!var6.hasNext()) {
               ...
               Collections.sort(this.mobNames, new Comparator() {
            ...
            mob = (CustomMob)var6.next();
         } while((!mob.isHostile || !this.options.showHostiles) && (!mob.isNeutral || !this.options.showNeutrals));
