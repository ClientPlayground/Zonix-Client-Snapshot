...
class GuiSlotDimensions extends GuiSlotMinimap {
   ...
   public GuiSlotDimensions(GuiScreenAddWaypoint par1GuiWaypoints) {
      ...
      this.scrollBy(this.dimensionManager.getDimensions().indexOf(this.dimensionManager.getDimensionByID(((Integer)this.parentGui.waypoint.dimensions.first()).intValue())) * this.slotHeight);
   }
