...
public class BlockIDRepository {
   ...
   public static void getIDs() {
      ...
      netherFenceID = Block.blockRegistry.getIDForObject(Block.blockRegistry.getObject("minecraft:nether_brick_fence"));
      ...
      shapedIDS = new Integer[]{signID, woodDoorID, ladderID, wallSignID, ironDoorID, stoneButtonID, fenceID, vineID, fenceGateID, netherFenceID, cobbleWallID, woodButtonID};
   }
