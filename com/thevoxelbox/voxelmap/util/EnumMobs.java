...
public enum EnumMobs {
   ...
   private EnumMobs(String name, boolean topLevelUnit, int expectedWidth, int squaredSize, String path, String secondaryPath, boolean isHostile, boolean isNeutral) {
      this.name = name;
