...
public class GLUtils {
   ...
   public static void setMap(int x, float y, int imageSize) {
      ...
      ldrawthree((double)(x - scale), (double)(y + (float)scale), 1.0D, 0.0D, 1.0D);
      ldrawthree((double)(x + scale), (double)(y + (float)scale), 1.0D, 1.0D, 1.0D);
      ldrawthree((double)(x + scale), (double)(y - (float)scale), 1.0D, 1.0D, 0.0D);
      ldrawthree((double)(x - scale), (double)(y - (float)scale), 1.0D, 0.0D, 0.0D);
   }
   ...
   public static void ldrawone(int a, int b, double c, double d, double e) {
      tesselator.addVertexWithUV((double)a, (double)b, c, d, e);
   }
   ...
   static {
      fboEnabled = GLContext.getCapabilities().GL_EXT_framebuffer_object && GLContext.getCapabilities().OpenGL14;
      fboTextureID = 0;
